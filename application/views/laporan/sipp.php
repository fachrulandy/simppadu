...
<aside class="right-side">
    ...
    <section class="content-header">
        <h1>
            Laporan
            <small>Rekap Bulanan SIPP</small>
        </h1>
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form" method="post">
                            <div id="form-utama">
                                ...
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-2 control-label">Per Kecamatan (Pemilik)</label>
                                    <div class="col-sm-4">
                                        <select class="form-control input-sm" name="id_kec_pemilik" id="id_kec_pemilik">
                                            <option></option>
