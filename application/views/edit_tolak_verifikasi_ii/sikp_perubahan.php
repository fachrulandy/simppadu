...
<div class="form-group">
    ...
    <div class="col-sm-7">
        <input value="<?php echo $edit->nama_tempat_kerja; ?>" type="text" class="form-control input-sm" name="nama_tempat_kerja" id="nama_tempat_kerja" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select name="id_kec_tempat_kerja" id="id_kec_tempat_kerja" class="form-control input-sm">
            <option value=""></option>
            <?php foreach ($kec as $r_kec): ?>
                <option <?php echo ($r_kec->id_kec == $edit->id_kec_tempat_kerja) ? 'selected=""' : '' ?> value="<?php echo $r_kec->id_kec; ?>"><?php echo $r_kec->nm_kec; ?></option>
            <?php endforeach; ?>
        </select>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select  name="id_kel_tempat_kerja" id="id_kel_tempat_kerja" class="form-control input-sm">
            <option value=""></option>
            <?php foreach ($kel as $r_kel): ?>
                <option <?php echo ($r_kel->id_kel == $edit->id_kel_tempat_kerja) ? 'selected=""' : '' ?> value="<?php echo $r_kel->id_kel; ?>"><?php echo $r_kel->nm_kel; ?></option>
            <?php endforeach; ?>
        </select>
        <p class="help-block">Jika ada kecamatan atau gampong yang belum tersedia, silahkan hubungi administrator untuk menambahkan</p>
    </div>
