...
<?php // echo "<pre>".print_r($edit, true)."</pre>"; ?>

<div class="row">
    <div class="col-lg-12">
        <?php switch ($edit->jenis_usaha) {
            case 'umum':
                ?>
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body" id="panel-umum">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input readonly="" type="number" class="form-control input-sm" name="umum_panjang" id="umum_panjang" value="<?php echo $edit->umum_panjang ?>">
                                </div>
                                <div class="col-sm-3">
                                    <input readonly="" type="number" class="form-control input-sm" name="umum_lebar" id="umum_lebar" value="<?php echo $edit->umum_lebar ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label">Jumlah Lantai</label>
                                <div class="col-sm-3">
                                    <input readonly="" type="number" class="form-control input-sm" name="umum_lantai" id="umum_lantai" value="<?php echo $edit->umum_lantai ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel-body" id="panel-tower">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input readonly="" type="number" class="form-control input-sm" name="total_luas" id="total_luas" value="<?php echo $edit->total_luas ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body" id="panel-tower">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input readonly="" type="number" class="form-control input-sm" name="tower_lahan_panjang" id="tower_lahan_panjang" value="<?php echo $edit->tower_lahan_panjang ?>">
                                </div>
                                <div class="col-sm-3">
                                    <input readonly="" type="number" class="form-control input-sm" name="tower_lahan_lebar" id="tower_lahan_lebar" value="<?php echo $edit->tower_lahan_lebar ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label">Akses Jalan : Panjang * Lebar</label>
                                <div class="col-sm-3">
                                    <input readonly="" type="number" class="form-control input-sm" name="tower_akses_jalan_panjang" id="tower_akses_jalan_panjang" value="<?php echo $edit->tower_akses_jalan_panjang ?>">
                                </div>
                                <div class="col-sm-3">
                                    <input readonly="" type="number" class="form-control input-sm" name="tower_akses_jalan_lebar" id="tower_akses_jalan_lebar" value="<?php echo $edit->tower_akses_jalan_lebar ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input readonly="" type="number" class="form-control input-sm" name="tower_tinggi" id="tower_tinggi" value="<?php echo $edit->tower_tinggi ?>">
                                </div>
                            </div>
                        </div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <input type="type" value="<?php echo $this->m_index_luas->get_nama_where_kode($edit->kode_index_luas) ?>" class="form-control input-sm" name="nama_index_luas" id="nama_index_luas" readonly="">
        <input type="hidden" value="<?php echo $edit->kode_index_luas ?>" class="form-control input-sm" name="kode_index_luas" id="kode_index_luas">
    </div>

    <div class="col-sm-1">
        <input type="text" value="<?php echo $this->m_index_luas->get_nilai($edit->kode_index_luas) ?>" readonly="" class="form-control input-sm" name="nilai_index_luas" id="nilai_index_luas">
    </div>
</div>
    ...
    <div class="col-sm-4">
        ...
        <select readonly="" class="form-control input-sm" name="kode_index_gangguan" id="kode_index_gangguan">
            ...
            <?php if($index_gangguan): foreach($index_gangguan as $r_index_gangguan): ?>
                <option <?php echo ($edit->kode_index_gangguan == $r_index_gangguan->kode_index_gangguan) ? 'selected=""' : '' ?> 
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <input readonly="" value="<?php echo $edit->nilai_retribusi ?>" type="text" class="form-control input-sm" name="nilai_retribusi" class="nilai_retribusi" id="nilai_retribusi">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6"><input readonly="" value="<?php echo $edit->tanggal_peninjauan_lapangan ?>" type="date" name="tanggal_peninjauan_lapangan" id="tanggal_peninjauan_lapangan" class="form-control input-sm"></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <select class="form-control input-sm" name="status_kepemilikan_tanah" id="status_kepemilikan_tanah">
            <option></option>
            <option <?php echo ($edit->status_kepemilikan_tanah == 'Hak Milik') ? 'selected=""' : '' ?> value="Hak Milik">Hak Milik</option>
            <option <?php echo ($edit->status_kepemilikan_tanah == 'Hak Pakai') ? 'selected=""' : '' ?> value="Hak Pakai">Hak Pakai</option>
            <option <?php echo ($edit->status_kepemilikan_tanah == 'Sewa') ? 'selected=""' : '' ?> value="Sewa">Sewa</option>
        </select>
    </div>
</div>
...
<input type="hidden" name="kode_index_luas" id="kode_index_luas" value="<?php echo $edit->kode_index_luas ?>">
<input type="hidden" name="kode_index_gangguan" id="kode_index_gangguan" value="<?php echo $edit->kode_index_gangguan ?>">
<input type="hidden" name="kode_index_lokasi" id="kode_index_lokasi" value="<?php echo $edit->kode_index_lokasi ?>">
<input type="hidden" name="kode_index_harga_dasar" id="kode_index_harga_dasar" value="<?php echo $edit->kode_index_harga_dasar ?>">
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <select class="form-control input-sm" name="bahan_bakar" id="bahan_bakar">
            <option <?php echo ($edit == 'Bensin') ? 'selected=""' : '' ?> value="Bensin">Bensin</option>
            <option <?php echo ($edit == 'Solar') ? 'selected=""' : '' ?> value="Solar">Solar</option>
        </select>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3"><input value="<?php echo $edit->tanggal_permohonan ?>" type="date" name="tanggal_permohonan" id="tanggal_permohonan" class="form-control input-sm"></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6" id="input_fields_wrap">
        <?php $array_memperhatikan = explode('|', $edit->memperhatikan); if(count($array_memperhatikan) > 0): foreach($array_memperhatikan as $memperhatikan): ?>
            <div class="row" style="margin-bottom: 15px;">
                <div class="col-sm-10">
                    <textarea name="memperhatikan[]" id="memperhatikan[]" class="form-control input-sm"><?php echo $memperhatikan ?></textarea>
                </div>
            </div>
        <?php endforeach; else: ?>
            <div class="row" style="margin-bottom: 15px;">
...
<div class="form-group">
    ...
    <div class="col-sm-6"><input readonly="" value="<?php echo $edit->tanggal_daftar_ulang ?>" type="date" name="tanggal_terbit" id="tanggal_terbit" class="form-control input-sm"></div>
</div>
<div class="form-group">
