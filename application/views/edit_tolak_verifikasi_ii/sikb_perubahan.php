...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input readonly="" value="<?php echo $edit->no_sk; ?>" type="text" class="form-control input-sm" name="no_sk_lalu" id="no_sk_lalu" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input  value="<?php echo $edit->no_sk; ?>" type="text" class="form-control input-sm" name="no_sk" id="no_sk" />
    </div>
</div>
...
<div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Kecamatan Perawat  <?php echo $edit->id_kec_pemilik ?></label>
    <div class="col-sm-4">
