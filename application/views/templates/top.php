                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview <?php echo ($this->uri->segment(1) == 'c_fo') ? 'active' : '' ?>">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li <?php echo ($this->uri->segment(2) == 'dalam_proses') ? 'class="active"' : '' ?>><a href="<?php echo site_url('c_fo/dalam_proses') ?>"><i class="fa fa-angle-double-right"></i> Dalam Proses</a></li>
