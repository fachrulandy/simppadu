...
<div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Nama Bidan</label>
    <div class="col-sm-3">
...
<div class="form-group">
    <label for="" class="col-sm-2 control-label">Alamat Bidan</label>
...
<div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Kecamatan Bidan</label>
    <div class="col-sm-4">
...
<div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Gampong Bidan</label>
    <div class="col-sm-4">
...
<div class="form-group">
    ...
    <div class="col-sm-5">
        <input readonly="" value="<?php echo $verifikasi->no_sib_str ?>" type="text" class="form-control input-sm" name="no_sib_str" id="no_sib_str" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input readonly="" value="<?php echo $verifikasi->nama_tempat_kerja; ?>" type="text" class="form-control input-sm" name="nama_tempat_praktek" id="nama_tempat_praktek" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6"><textarea readonly="" name="alamat_tempat_kerja" id="alamat_tempat_kerja" class="form-control input-sm"><?php echo $verifikasi->alamat_tempat_kerja ?></textarea></div>
</div>

<div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Kecamatan Tempat Kerja</label>
    <div class="col-sm-4">
        <select readonly="" name="id_kec_tempat_kerja" id="id_kec_tempat_kerja" class="form-control input-sm">
            <option value=""></option>
            <?php foreach ($kec as $r_kec): ?>
                <option <?php echo ($verifikasi->id_kec_tempat_kerja == $r_kec->id_kec) ? 'selected=""' : '' ?> value="<?php echo $r_kec->id_kec; ?>"><?php echo $r_kec->nm_kec; ?></option>
            <?php endforeach; ?>
        </select>
    </div>
</div>
...
<div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Gampong Tempat Kerja</label>
    <div class="col-sm-4">
        <select readonly="" name="id_kel_tempat_kerja" id="id_kel_tempat_kerja" class="form-control input-sm">
            <option value=""></option>
            <?php foreach ($kel as $r_kel): ?>
                <option <?php echo ($verifikasi->id_kel_tempat_kerja == $r_kel->id_kel) ? 'selected=""' : '' ?> value="<?php echo $r_kel->id_kel; ?>"><?php echo $r_kel->nm_kel; ?></option>
            <?php endforeach; ?>
        </select>
        <p class="help-block">Jika ada kecamatan atau gampong yang belum tersedia, silahkan hubungi administrator untuk menambahkan</p>
    </div>
