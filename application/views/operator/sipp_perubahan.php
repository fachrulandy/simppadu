    ...
    <div class="col-sm-4">
        <select name="id_kec_pemilik" id="id_kec_pemilik" class="form-control input-sm">
            ...
            <?php foreach ($kec as $r_kec): ?>
                <option <?php echo ($r_kec->id_kec == $data_lalu->id_kec_pemilik) ? 'selected=""' : '' ?> value="<?php echo $r_kec->id_kec; ?>"><?php echo $r_kec->nm_kec; ?></option>
            <?php endforeach; ?>
        </select>
    </div>
</div>
    ...
    <div class="col-sm-4">
        <select name="id_kel_pemilik" id="id_kel_pemilik" class="form-control input-sm">
            ...
            <?php foreach ($kel as $r_kel): ?>
                <option <?php echo ($r_kel->id_kel == $data_lalu->id_kel_pemilik) ? 'selected=""' : '' ?> value="<?php echo $r_kel->id_kel; ?>"><?php echo $r_kel->nm_kel; ?></option>
            <?php endforeach; ?>
        </select>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $data_lalu->no_surat_tanda_reg_perawat ?>" type="text" class="form-control input-sm" name="no_surat_tanda_reg_perawat" id="no_surat_tanda_reg_perawat" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $data_lalu->nama_tempat_praktek; ?>" type="text" class="form-control input-sm" name="nama_tempat_praktek" id="nama_tempat_praktek" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6"><textarea name="alamat_tempat_praktek" id="alamat_tempat_praktek" class="form-control input-sm"><?php echo $data_lalu->alamat_tempat_praktek ?></textarea></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select name="id_kec_tempat_praktek" id="id_kec_tempat_praktek" class="form-control input-sm">
            <option value=""></option>
            <?php foreach ($kec as $r_kec): ?>
                <option <?php echo ($r_kec->id_kec == $data_lalu->id_kec_tempat_praktek) ? 'selected=""' : '' ?> value="<?php echo $r_kec->id_kec; ?>"><?php echo $r_kec->nm_kec; ?></option>
            <?php endforeach; ?>
        </select>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select name="id_kel_tempat_praktek" id="id_kel_tempat_praktek" class="form-control input-sm">
            <option value=""></option>
            <?php foreach ($kel as $r_kel): ?>
                <option <?php echo ($r_kel->id_kel == $data_lalu->id_kel_tempat_praktek) ? 'selected=""' : '' ?> value="<?php echo $r_kel->id_kel; ?>"><?php echo $r_kel->nm_kel; ?></option>
            <?php endforeach; ?>
        </select>
        <p class="help-block">Jika ada kecamatan atau gampong yang belum tersedia, silahkan hubungi administrator untuk menambahkan</p>
    </div>
