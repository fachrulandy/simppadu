...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $fo->sipb_baru_nama_pemilik; ?>" type="text" class="form-control input-sm" name="nama_pemilik" id="nama_pemilik" />
    </div>
</div>
...
<div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Kelurahan Bidan</label>
    <div class="col-sm-4">
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="" type="text" class="form-control input-sm" name="no_surat_tanda_reg_bidan" id="no_surat_tanda_reg_bidan" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $fo->sipb_baru_nama_tempat_praktek; ?>" type="text" class="form-control input-sm" name="nama_tempat_praktek" id="nama_tempat_praktek" />
    </div>
</div>
