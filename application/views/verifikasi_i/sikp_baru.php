...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input readonly="" value="<?php echo $verifikasi->sikp_baru_nama_pemilik ?>" type="text" class="form-control input-sm" name="sikp_baru_nama_pemilik" id="sikp_baru_nama_pemilik" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input readonly="" value="<?php echo $verifikasi->sikp_baru_nama_tempat_kerja ?>" type="text" class="form-control input-sm" name="sikp_baru_nama__kerja" id="sikp_baru_nama_kerja" />
    </div>
</div>
