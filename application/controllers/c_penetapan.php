		...
		if($this->input->post('tetapkan')){
			...
			switch ($data['nama_sub_modul']) {
				...
				case 'ho_baru':
					...
					$data_penetapan['ho_baru_jenis_usaha']          = $this->input->post('ho_baru_jenis_usaha');

					switch ($data_penetapan['ho_baru_jenis_usaha']) {
						case 'umum':
							$data_penetapan['ho_baru_umum_panjang'] = $this->input->post('ho_baru_umum_panjang');
							$data_penetapan['ho_baru_umum_lebar']   = $this->input->post('ho_baru_umum_lebar');
							$data_penetapan['ho_baru_umum_lantai']  = $this->input->post('ho_baru_umum_lantai');
							break;

						case 'tower':
							$data_penetapan['ho_baru_tower_lahan_panjang']       = $this->input->post('ho_baru_tower_lahan_panjang');
							$data_penetapan['ho_baru_tower_lahan_lebar']         = $this->input->post('ho_baru_tower_lahan_lebar');
							$data_penetapan['ho_baru_tower_akses_jalan_panjang'] = $this->input->post('ho_baru_tower_akses_jalan_panjang');
							$data_penetapan['ho_baru_tower_akses_jalan_lebar']   = $this->input->post('ho_baru_tower_akses_jalan_lebar');
							$data_penetapan['ho_baru_tower_tinggi']              = $this->input->post('ho_baru_tower_tinggi');
							break;
					}

					$data_penetapan['ho_baru_total_luas']                  = $this->input->post('ho_baru_total_luas');
