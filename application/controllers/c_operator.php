			...
			switch ($data['nama_sub_modul']) {
				...
				case 'ho_baru':
					...
					$simpan = $this->db->update('t_ho', array(
						...
						'umum_panjang'                => $this->input->post('umum_panjang'),
						'umum_lebar'                  => $this->input->post('umum_lebar'),
						'umum_lantai'                 => $this->input->post('umum_lantai'),
						'tower_lahan_panjang'         => $this->input->post('tower_lahan_panjang'),
						'tower_lahan_lebar'           => $this->input->post('tower_lahan_lebar'),
						'tower_akses_jalan_panjang'   => $this->input->post('tower_akses_jalan_panjang'),
						'tower_akses_jalan_lebar'     => $this->input->post('tower_akses_jalan_lebar'),
						'tower_tinggi'                => $this->input->post('tower_tinggi'),
						'total_luas'                  => $this->input->post('total_luas'),
						...
						'memperhatikan'               => implode('|', $this->input->post('memperhatikan')),
						'status_berlaku'              => 1
					));
		...
		if($this->input->post('simpan')){
			...
			switch ($data['nama_sub_modul']) {
				...
				case 'ho_baru':
					...
					$simpan = $this->db->update('t_ho', $update);
