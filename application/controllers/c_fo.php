...
class C_fo extends CI_Controller {
            ...
            switch ($this->m_sub_modul->get_nama_sub_modul($this->input->post('id_sub_modul'))) {
               ...
               case 'siuk_baru':
                ...
                case 'sipp_baru':
                 ...
                 case 'sipp_perpanjangan':
                    $data_pendaftaran['sipp_perpanjangan_no_sk']            = $this->input->post('sipp_perpanjangan_no_sk');
                    $data_pendaftaran['sipp_perpanjangan_status_perubahan'] = $this->input->post('sipp_perpanjangan_status_perubahan');
                    break;

                case 'sipp_perubahan':
                    $data_pendaftaran['sipp_perubahan_no_sk']            = $this->input->post('sipp_perubahan_no_sk');
                    break;
    ...
    public function cetak_ttb($no_daftar){
        ...
        switch ($guna) {
            ...
            case 'sipp_baru':
                array_push($array_ttb, ['field' => 'Nama Pemilik', 'value' => $data->sipp_baru_nama_pemilik]);
                array_push($array_ttb, ['field' => 'Nama Optik', 'value' => $data->sipp_baru_nama_tempat_praktek]);
                break;

             case 'sipp_perpanjangan':
                $data_lalu = $this->m_sipp->get_where_no_sk($data->sipp_perpanjangan_no_sk);
                array_push($array_ttb, ['field' => 'Nama Pemilik', 'value' => $data_lalu->nama_pemilik]);
                array_push($array_ttb, ['field' => 'Nama Tempat Praktek', 'value' => $data_lalu->nama_tempat_praktek]);
                break;

            case 'sipp_perubahan':
                $data_lalu = $this->m_sipp->get_where_no_sk($data->sipp_perubahan_no_sk);
                array_push($array_ttb, ['field' => 'Nama Pemilik', 'value' => $data_lalu->nama_pemilik]);
                array_push($array_ttb, ['field' => 'Nama Tempat Praktek', 'value' => $data_lalu->nama_tempat_praktek]);
                break;
