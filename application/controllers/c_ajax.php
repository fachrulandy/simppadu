...
class C_ajax extends CI_Controller{
	...
	public function load_data_sipp_perpanjangan(){

		if($this->input->get('no_sk')){
			
			$no_sk = $this->input->get('no_sk');	
			$data  = $this->m_sipp->get_where_no_sk($no_sk);
			...
			if($data){
				...
				?>
				<tr>
					<input type="hidden" name="sipp_perpanjangan_no_sk" id="sipp_perpanjangan_no_sk" value="<?php echo $data->no_sk; ?>">
					<td><?php echo $data->no_sk; ?></td>
					<td><?php echo $data->nama_pemilik; ?></td>
					<td><?php echo $data->nama_tempat_praktek; ?></td>
					<td><?php echo $data->tanggal_terbit; ?></td>
					<td><?php echo $data->tanggal_perpanjangan; ?></td>
				</tr>
	...
	public function load_data_sipp_perubahan(){
		...
		if($this->input->get('no_sk')){
			...
			if($data){
				...
				?>
				<tr>
					<input type="hidden" name="sipp_perubahan_no_sk" id="sipp_perubahan_no_sk" value="<?php echo $data->no_sk; ?>">
					<td><?php echo $data->no_sk; ?></td>
					<td><?php echo $data->nama_pemilik; ?></td>
					<td><?php echo $data->nama_tempat_praktek; ?></td>
					<td><?php echo $data->tanggal_terbit; ?></td>
	...
	public function load_data_sikb_perpanjangan(){
		...
		if($this->input->get('no_sk')){
			...
			if($data){
				...
				?>
				<tr>
					<input type="hidden" name="sikb_perpanjangan_no_sk" id="sikb_perpanjangan_no_sk" value="<?php echo $data->no_sk; ?>">
					<td><?php echo $data->no_sk; ?></td>
					<td><?php echo $data->nama_pemilik; ?></td>
	...
	public function load_data_sikb_perubahan(){
		...
		if($this->input->get('no_sk')){
			...
			if($data){
				...
				?>
				<tr>
					<input type="hidden" name="sikb_perubahan_no_sk" id="sikb_perubahan_no_sk" value="<?php echo $data->no_sk; ?>">
					<td><?php echo $data->no_sk; ?></td>
					<td><?php echo $data->nama_pemilik; ?></td>
	...
	public function load_data_sikp_perpanjangan(){
		...
		if($this->input->get('no_sk')){
			...
			if($data){
				...
				?>
				<tr>
					<input type="hidden" name="sikp_perpanjangan_no_sk" id="sikp_perpanjangan_no_sk" value="<?php echo $data->no_sk; ?>">
					<td><?php echo $data->no_sk; ?></td>
					<td><?php echo $data->nama_pemilik; ?></td>
	...
	public function load_data_sikp_perubahan(){
		...
		if($this->input->get('no_sk')){
			...
			if($data){
				...
				?>
				<tr>
					<input type="hidden" name="sikp_perubahan_no_sk" id="sikp_perubahan_no_sk" value="<?php echo $data->no_sk; ?>">
					<td><?php echo $data->no_sk; ?></td>
					<td><?php echo $data->nama_pemilik; ?></td>
